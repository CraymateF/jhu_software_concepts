...
NOTE: data_updater.py was replaced by consumer.py in the worker service
in module_6. These tests are skipped - the underlying logic now lives
in the worker container and is not importable from src/web.
"""
import pytest
...
pytestmark = pytest.mark.skip(
    reason="data_updater.py moved to worker/consumer.py in module_6; not importable from web service"
)
