...
NOTE: These tests rely on data_updater.get_db_params and
load_data.get_db_params which do not exist in module_6.
Skipped – equivalent coverage is provided by test_db_helpers.py
for query_data.get_db_connection.
"""
...
pytestmark = pytest.mark.skip(
    reason="data_updater.get_db_params / load_data.get_db_params removed in module_6"
)
